...
# CLASS to give funtionality to Spectral Decomposition Tool Window
class SpecDecomp_Main_Window(qtw.QMainWindow):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

        self.ui_SpecDecon = Ui_SpecDecomTool_Main()
        self.ui_SpecDecon.setupUi(self)
